...
class HDR:
    ...
    def __init__(self, path, filenames, exposure_times):
        ...
        Конструктор загружает изображения, устанавливает времена экспонирования и выравнивает их с помощью алгоритма MTB (Median Threshold Bitmap).
    ...
    def samplingValues(self):
        ...
        X = np.log(self.times)  # Логарифмические времена экспонирования.
...
class PostProcess(HDR):
    ...
    def photograph_tone_mapping(self):
        ...
        a = 0.2  # Коэффициент масштабирования
        Ld = (a / Lavg) * lum
